...
# X25519 helpers
# ---------------------------------------------------------------------
# X25519 is a fast, modern Diffie-Hellman variant on Curve25519.
# Public key:  32 bytes
...
# ---------------------------------------------------------------------
# Client-side: receive server's public keys, generate hybrid response
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# Server-side: receive client's response, derive same hybrid secret
# ---------------------------------------------------------------------
